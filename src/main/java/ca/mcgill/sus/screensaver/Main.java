...
public class Main {
	...
	//	public static final boolean LOGGED_IN = false; // useful for debugging
	public final static boolean OFFICE_COMPUTER = System.getenv("computerName").matches(Config.INSTANCE.getOffice_regex());
	public static final int COLOR_DOWN = LOGGED_IN ? 0xbbdc241f : 0xaaf11700,
							COLOR_UP = LOGGED_IN ? 0xcc50c954 : 0xaaaad400,
